...
SELECT t.KODE, t.TANGGAL, p.NAMA AS NAMA_PELANGGAN, b.NAMA AS NAMA_BARANG, t.JUMLAH_BARANG AS JUMLAH, ROUND(b.HARGA_SATUAN, 0) AS HARGA_SATUAN, ROUND(t.JUMLAH_BARANG * b.HARGA_SATUAN, 0) AS TOTAL
