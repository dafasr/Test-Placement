...
SELECT t.KODE, t.TANGGAL, p.NAMA AS NAMA_PELANGGAN, b.NAMA AS NAMA_BARANG, t.JUMLAH_BARANG AS JUMLAH, b.HARGA_SATUAN, (t.JUMLAH_BARANG * b.HARGA_SATUAN) AS TOTAL
